...
class aButton:
    ...
    def __init__(self, pin, suppress=False):
        ...
        loop = asyncio.get_event_loop()
        self._run = loop.create_task(self.buttoncheck())  # Thread runs forever

    def pressed(self, func, args=()):
        self._tf = func
        self._ta = args

    def released(self, func, args=()):
        self._ff = func
        self._fa = args

    def double_pressed(self, func, args=()):
        self._df = func
        self._da = args

    def long_pressed(self, func, args=()):
        self._lf = func
        self._la = args
